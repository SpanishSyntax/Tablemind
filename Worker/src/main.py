...
from shared_db import init_db, SessionAsync

from models import Chunk_on_db, Job_on_db, JobStatus
from models import Prompt_on_db, Model_on_db, APIKey_on_db
...
async def process_job_async(job_id: str):
    ...
    async with SessionAsync() as session:
        try:
            ...
            api_key = decrypt(api_key_obj.api_key)
